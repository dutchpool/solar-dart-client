import 'package:dart_client/api/transactions/models/broadcast/broadcast_transaction_asset_request.dart';
...
class BroadcastTransactionRequest with _$BroadcastTransactionRequest {
  const factory BroadcastTransactionRequest({
    ...
    @JsonKey(name: "memo", includeIfNull: false) String? memo,
    @JsonKey(name: "memoHex", includeIfNull: false) String? memoHex,
