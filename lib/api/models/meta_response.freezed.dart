...
/// @nodoc
@JsonSerializable()
class _$_MetaResponse extends _MetaResponse {
  ...
  @override
  String toString() {
    return 'MetaResponse(totalCountIsEstimate: $totalCountIsEstimate, count: $count, pageCount: $pageCount, totalCount: $totalCount, next: $next, previous: $previous, self: $self, first: $first, last: $last)';
  }
...
abstract class _MetaResponse extends MetaResponse {
  const factory _MetaResponse(
      {@JsonKey(name: 'totalCountIsEstimate')
          required final bool totalCountIsEstimate,
      @JsonKey(name: 'count')
      ...
      @JsonKey(name: 'first')
          final String? first,
      @JsonKey(name: 'last')
          final String? last}) = _$_MetaResponse;
  const _MetaResponse._() : super._();
