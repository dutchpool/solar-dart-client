...
CryptoResponseDataMilestoneFeesStaticFees
    _$CryptoResponseDataMilestoneFeesStaticFeesFromJson(
        Map<String, dynamic> json) {
  return _CryptoResponseDataMilestoneFeesStaticFees.fromJson(json);
}

/// @nodoc
mixin _$CryptoResponseDataMilestoneFeesStaticFees {
  @JsonKey(name: 'burn')
  ...
  @JsonKey(ignore: true)
  $CryptoResponseDataMilestoneFeesStaticFeesCopyWith<
          CryptoResponseDataMilestoneFeesStaticFees>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CryptoResponseDataMilestoneFeesStaticFeesCopyWith<$Res> {
  factory $CryptoResponseDataMilestoneFeesStaticFeesCopyWith(
          CryptoResponseDataMilestoneFeesStaticFees value,
          $Res Function(CryptoResponseDataMilestoneFeesStaticFees) then) =
      _$CryptoResponseDataMilestoneFeesStaticFeesCopyWithImpl<$Res,
          CryptoResponseDataMilestoneFeesStaticFees>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CryptoResponseDataMilestoneFeesStaticFeesCopyWithImpl<$Res,
        $Val extends CryptoResponseDataMilestoneFeesStaticFees>
    implements $CryptoResponseDataMilestoneFeesStaticFeesCopyWith<$Res> {
  _$CryptoResponseDataMilestoneFeesStaticFeesCopyWithImpl(
...
/// @nodoc
abstract class _$$_CryptoResponseDataMilestoneFeesStaticFeesCopyWith<$Res>
    implements $CryptoResponseDataMilestoneFeesStaticFeesCopyWith<$Res> {
  factory _$$_CryptoResponseDataMilestoneFeesStaticFeesCopyWith(
          _$_CryptoResponseDataMilestoneFeesStaticFees value,
          $Res Function(_$_CryptoResponseDataMilestoneFeesStaticFees) then) =
      __$$_CryptoResponseDataMilestoneFeesStaticFeesCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'burn') int? burn,
...
/// @nodoc
class __$$_CryptoResponseDataMilestoneFeesStaticFeesCopyWithImpl<$Res>
    extends _$CryptoResponseDataMilestoneFeesStaticFeesCopyWithImpl<$Res,
        _$_CryptoResponseDataMilestoneFeesStaticFees>
    implements _$$_CryptoResponseDataMilestoneFeesStaticFeesCopyWith<$Res> {
  __$$_CryptoResponseDataMilestoneFeesStaticFeesCopyWithImpl(
      _$_CryptoResponseDataMilestoneFeesStaticFees _value,
      $Res Function(_$_CryptoResponseDataMilestoneFeesStaticFees) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_CryptoResponseDataMilestoneFeesStaticFees(
      burn: freezed == burn
          ? _value.burn
          : burn // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$_CryptoResponseDataMilestoneFeesStaticFees
    implements _CryptoResponseDataMilestoneFeesStaticFees {
  const _$_CryptoResponseDataMilestoneFeesStaticFees(
  ...
  factory _$_CryptoResponseDataMilestoneFeesStaticFees.fromJson(
          Map<String, dynamic> json) =>
      _$$_CryptoResponseDataMilestoneFeesStaticFeesFromJson(json);
  ...
  @override
  String toString() {
    return 'CryptoResponseDataMilestoneFeesStaticFees(burn: $burn, delegateRegistration: $delegateRegistration, delegateResignation: $delegateResignation, htlcClaim: $htlcClaim, htlcLock: $htlcLock, htlcRefund: $htlcRefund, ipfs: $ipfs, legacyTransfer: $legacyTransfer, legacyVote: $legacyVote, multiSignature: $multiSignature, secondSignature: $secondSignature, transfer: $transfer, vote: $vote)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_CryptoResponseDataMilestoneFeesStaticFees &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_CryptoResponseDataMilestoneFeesStaticFeesCopyWith<
          _$_CryptoResponseDataMilestoneFeesStaticFees>
      get copyWith =>
          __$$_CryptoResponseDataMilestoneFeesStaticFeesCopyWithImpl<
              _$_CryptoResponseDataMilestoneFeesStaticFees>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_CryptoResponseDataMilestoneFeesStaticFeesToJson(
      this,
    );
  }
}

abstract class _CryptoResponseDataMilestoneFeesStaticFees
    implements CryptoResponseDataMilestoneFeesStaticFees {
  const factory _CryptoResponseDataMilestoneFeesStaticFees(
      {@JsonKey(name: 'burn')
          final int? burn,
      @JsonKey(name: 'delegateRegistration')
          final int? delegateRegistration,
      ...
      @JsonKey(name: 'transfer')
          final int? transfer,
      @JsonKey(name: 'vote')
          final int? vote}) = _$_CryptoResponseDataMilestoneFeesStaticFees;

  factory _CryptoResponseDataMilestoneFeesStaticFees.fromJson(
          Map<String, dynamic> json) =
      _$_CryptoResponseDataMilestoneFeesStaticFees.fromJson;
