...
part 'configuration_crypto_response_data_milestone_fees_static_fees.freezed.dart';

part 'configuration_crypto_response_data_milestone_fees_static_fees.g.dart';

@freezed
abstract class CryptoResponseDataMilestoneFeesStaticFees
    with _$CryptoResponseDataMilestoneFeesStaticFees {
  const factory CryptoResponseDataMilestoneFeesStaticFees({
  ...
  }) = _CryptoResponseDataMilestoneFeesStaticFees;

  factory CryptoResponseDataMilestoneFeesStaticFees.fromJson(
          Map<String, dynamic> json) =>
      _$CryptoResponseDataMilestoneFeesStaticFeesFromJson(json);
}
